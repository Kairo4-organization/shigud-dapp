                  ...
                  properties: {
                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        sharedSecret: hexString32,
                        programId: { type: 'string', description: 'SIP Privacy program ID' },
                        noteId: { type: 'string', nullable: true, description: 'Transfer record PDA (base58). Null when using SystemProgram fallback.' },
                        instructionType: { type: 'string', enum: ['anchor', 'system'], description: 'Which program path was used for the transaction.' },
                        encryptedAmount: { type: 'string', nullable: true, description: 'Amount encrypted with viewing key hash (hex). Only present on Anchor path.' },
                      },
                    },
                  },
                },
