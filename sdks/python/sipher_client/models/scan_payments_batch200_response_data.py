...
class ScanPaymentsBatch200ResponseData(BaseModel):
    """
    ScanPaymentsBatch200ResponseData
    """ # noqa: E501
    results: Optional[List[ScanPaymentsBatch200ResponseDataResultsInner]] = None
    summary: Optional[ScanPaymentsBatch200ResponseDataSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ScanPaymentsBatch200ResponseDataResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "summary": ScanPaymentsBatch200ResponseDataSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
