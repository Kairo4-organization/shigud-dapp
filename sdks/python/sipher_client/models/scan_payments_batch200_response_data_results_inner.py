...
class ScanPaymentsBatch200ResponseDataResultsInner(BaseModel):
    """
    ...
    data: Optional[ScanPaymentsBatch200ResponseDataResultsInnerData] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["index", "label", "success", "data", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ScanPaymentsBatch200ResponseDataResultsInnerData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
