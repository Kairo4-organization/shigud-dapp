...
class CommitmentCreateBatch200ResponseData(BaseModel):
    """
    CommitmentCreateBatch200ResponseData
    """ # noqa: E501
    results: Optional[List[CommitmentCreateBatch200ResponseDataResultsInner]] = None
    summary: Optional[StealthGenerateBatch200ResponseDataSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [CommitmentCreateBatch200ResponseDataResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "summary": StealthGenerateBatch200ResponseDataSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
