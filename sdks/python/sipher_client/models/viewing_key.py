...
class ViewingKey(BaseModel):
    """
    ViewingKey
    """ # noqa: E501
    key: Annotated[str, Field(strict=True)] = Field(description="0x-prefixed 32-byte hex string")
    path: StrictStr
    hash: Annotated[str, Field(strict=True)] = Field(description="0x-prefixed 32-byte hex string")
