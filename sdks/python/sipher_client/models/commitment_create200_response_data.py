...
class CommitmentCreate200ResponseData(BaseModel):
    """
    CommitmentCreate200ResponseData
    """ # noqa: E501
    commitment: Optional[StrictStr] = Field(default=None, description="Hex-encoded curve point")
    blinding_factor: Optional[StrictStr] = Field(default=None, alias="blindingFactor")
    __properties: ClassVar[List[str]] = ["commitment", "blindingFactor"]
