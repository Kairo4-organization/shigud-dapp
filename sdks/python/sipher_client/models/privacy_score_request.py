...
class PrivacyScoreRequest(BaseModel):
    ...
    limit: Optional[Annotated[int, Field(le=500, strict=True, ge=10)]] = Field(default=100, description="Number of recent transactions to analyze")
    __properties: ClassVar[List[str]] = ["address", "limit"]
