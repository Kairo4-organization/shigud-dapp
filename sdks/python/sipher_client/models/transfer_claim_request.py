...
class TransferClaimRequest(BaseModel):
    ...
    """ # noqa: E501
    stealth_address: Annotated[str, Field(min_length=32, strict=True, max_length=44)] = Field(description="Base58-encoded Solana public key", alias="stealthAddress")
    ephemeral_public_key: Annotated[str, Field(min_length=32, strict=True, max_length=44)] = Field(description="Base58-encoded Solana public key", alias="ephemeralPublicKey")
    ...
    destination_address: Annotated[str, Field(min_length=32, strict=True, max_length=44)] = Field(description="Base58-encoded Solana public key", alias="destinationAddress")
    mint: Annotated[str, Field(min_length=32, strict=True, max_length=44)] = Field(description="Base58-encoded Solana public key")
    __properties: ClassVar[List[str]] = ["stealthAddress", "ephemeralPublicKey", "spendingPrivateKey", "viewingPrivateKey", "destinationAddress", "mint"]
