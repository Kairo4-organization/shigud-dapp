...
class ViewingKeyDecryptRequestEncrypted(BaseModel):
    """
    ViewingKeyDecryptRequestEncrypted
    """ # noqa: E501
    ciphertext: Annotated[str, Field(strict=True)]
    nonce: Annotated[str, Field(strict=True)]
    viewing_key_hash: Annotated[str, Field(strict=True)] = Field(description="0x-prefixed 32-byte hex string", alias="viewingKeyHash")
    __properties: ClassVar[List[str]] = ["ciphertext", "nonce", "viewingKeyHash"]
