...
class StealthGenerateBatchRequest(BaseModel):
    """
    StealthGenerateBatchRequest
    """ # noqa: E501
    count: Annotated[int, Field(le=100, strict=True, ge=1)] = Field(description="Number of keypairs to generate")
    label: Optional[StrictStr] = Field(default=None, description="Optional label applied to all keypairs")
    __properties: ClassVar[List[str]] = ["count", "label"]
