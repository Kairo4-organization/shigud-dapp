...
class ScanPayments200ResponseDataPaymentsInner(BaseModel):
    """
    ...
    tx_signature: Optional[StrictStr] = Field(default=None, alias="txSignature")
    slot: Optional[StrictInt] = None
    timestamp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["stealthAddress", "ephemeralPublicKey", "txSignature", "slot", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "txSignature": obj.get("txSignature"),
            "slot": obj.get("slot"),
