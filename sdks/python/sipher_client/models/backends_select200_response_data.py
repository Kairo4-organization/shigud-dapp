...
class BackendsSelect200ResponseData(BaseModel):
    """
    BackendsSelect200ResponseData
    """ # noqa: E501
    key_id: Optional[StrictStr] = Field(default=None, alias="keyId")
    preferred_backend: Optional[StrictStr] = Field(default=None, alias="preferredBackend")
    __properties: ClassVar[List[str]] = ["keyId", "preferredBackend"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keyId": obj.get("keyId"),
            "preferredBackend": obj.get("preferredBackend")
        })
        return _obj
