...
class GetRpcProviders200ResponseDataActive(BaseModel):
    """
    GetRpcProviders200ResponseDataActive
    """ # noqa: E501
    provider: Optional[StrictStr] = None
    endpoint: Optional[StrictStr] = Field(default=None, description="Masked RPC endpoint URL")
    ...
    __properties: ClassVar[List[str]] = ["provider", "endpoint", "connected", "cluster", "latencyMs"]
    ...
    def provider_validate_enum(cls, value):
        ...
        if value not in set(['generic', 'helius', 'quicknode', 'triton']):
            raise ValueError("must be one of enum values ('generic', 'helius', 'quicknode', 'triton')")
        return value
