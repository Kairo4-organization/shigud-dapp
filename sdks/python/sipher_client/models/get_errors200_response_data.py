...
class GetErrors200ResponseData(BaseModel):
    """
    GetErrors200ResponseData
    """ # noqa: E501
    total_codes: Optional[StrictInt] = Field(default=None, alias="totalCodes")
    errors: Optional[List[GetErrors200ResponseDataErrorsInner]] = None
    __properties: ClassVar[List[str]] = ["totalCodes", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [GetErrors200ResponseDataErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
