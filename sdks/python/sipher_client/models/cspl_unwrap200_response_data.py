...
class CsplUnwrap200ResponseData(BaseModel):
    """
    CsplUnwrap200ResponseData
    """ # noqa: E501
    signature: Optional[StrictStr] = Field(default=None, description="Transaction signature")
    amount: Optional[StrictStr] = Field(default=None, description="Decrypted amount as string")
    __properties: ClassVar[List[str]] = ["signature", "amount"]
