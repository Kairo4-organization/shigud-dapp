...
class CommitmentCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    value: Annotated[str, Field(strict=True)] = Field(description="Non-negative integer string")
    blinding_factor: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Optional custom blinding factor", alias="blindingFactor")
    __properties: ClassVar[List[str]] = ["value", "blindingFactor"]
