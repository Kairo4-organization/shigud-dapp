...
class NearTransferDataActionsInner(BaseModel):
    """
    ...
    deposit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "amount", "methodName", "args", "gas", "deposit"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Transfer', 'FunctionCall']):
            raise ValueError("must be one of enum values ('Transfer', 'FunctionCall')")
        return value
