...
class StealthDerive200Response(BaseModel):
    """
    StealthDerive200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[StealthDerive200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": StealthDerive200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
