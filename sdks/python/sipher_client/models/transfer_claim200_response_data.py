...
class TransferClaim200ResponseData(BaseModel):
    """
    ...
    explorer_url: Optional[StrictStr] = Field(default=None, alias="explorerUrl")
    __properties: ClassVar[List[str]] = ["txSignature", "destinationAddress", "amount", "explorerUrl"]
