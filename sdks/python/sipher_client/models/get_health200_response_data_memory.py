...
class GetHealth200ResponseDataMemory(BaseModel):
    """
    GetHealth200ResponseDataMemory
    """ # noqa: E501
    heap_used_mb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="heapUsedMB")
    rss_mb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rssMB")
    __properties: ClassVar[List[str]] = ["heapUsedMB", "rssMB"]
