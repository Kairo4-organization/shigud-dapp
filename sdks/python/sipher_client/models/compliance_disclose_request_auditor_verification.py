...
class ComplianceDiscloseRequestAuditorVerification(BaseModel):
    """
    ComplianceDiscloseRequestAuditorVerification
    """ # noqa: E501
    auditor_key_hash: Annotated[str, Field(strict=True)] = Field(alias="auditorKeyHash")
    nonce: Annotated[str, Field(strict=True)]
    __properties: ClassVar[List[str]] = ["auditorKeyHash", "nonce"]

    @field_validator('auditor_key_hash')
    def auditor_key_hash_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auditorKeyHash": obj.get("auditorKeyHash"),
            "nonce": obj.get("nonce")
        })
        return _obj
