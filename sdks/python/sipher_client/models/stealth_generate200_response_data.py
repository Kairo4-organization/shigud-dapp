...
class StealthGenerate200ResponseData(BaseModel):
    """
    StealthGenerate200ResponseData
    """ # noqa: E501
    meta_address: Optional[StealthMetaAddress] = Field(default=None, alias="metaAddress")
    spending_private_key: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="0x-prefixed 32-byte hex string", alias="spendingPrivateKey")
    viewing_private_key: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="0x-prefixed 32-byte hex string", alias="viewingPrivateKey")
    __properties: ClassVar[List[str]] = ["metaAddress", "spendingPrivateKey", "viewingPrivateKey"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of meta_address
        if self.meta_address:
            _dict['metaAddress'] = self.meta_address.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metaAddress": StealthMetaAddress.from_dict(obj["metaAddress"]) if obj.get("metaAddress") is not None else None,
