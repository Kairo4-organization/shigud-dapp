...
class PrivateSwap200ResponseDataTransactionsInner(BaseModel):
    """
    PrivateSwap200ResponseDataTransactionsInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    transaction: Optional[StrictStr] = Field(default=None, description="Base64-encoded transaction or signature")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "transaction", "description"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['wrap', 'swap']):
            raise ValueError("must be one of enum values ('wrap', 'swap')")
        return value
