...
class SolanaTransferData(BaseModel):
    """
    SolanaTransferData
    """ # noqa: E501
    type: StrictStr
    transaction: StrictStr = Field(description="Base64-encoded unsigned transaction")
    mint: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "transaction", "mint"]
