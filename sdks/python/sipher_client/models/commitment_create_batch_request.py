...
class CommitmentCreateBatchRequest(BaseModel):
    """
    CommitmentCreateBatchRequest
    """ # noqa: E501
    items: Annotated[List[CommitmentCreateBatchRequestItemsInner], Field(min_length=1, max_length=100)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CommitmentCreateBatchRequestItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
