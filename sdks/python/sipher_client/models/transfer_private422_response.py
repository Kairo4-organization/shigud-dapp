...
class TransferPrivate422Response(BaseModel):
    """
    TransferPrivate422Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    error: Optional[TransferPrivate422ResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": TransferPrivate422ResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
