...
class ViewingKeyGenerateRequest(BaseModel):
    """
    ViewingKeyGenerateRequest
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default='m/0', description="Derivation path")
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["path", "label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "path": obj.get("path") if obj.get("path") is not None else 'm/0',
            "label": obj.get("label")
        })
        return _obj
