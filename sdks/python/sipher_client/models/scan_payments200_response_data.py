...
class ScanPayments200ResponseData(BaseModel):
    """
    ScanPayments200ResponseData
    """ # noqa: E501
    payments: Optional[List[ScanPayments200ResponseDataPaymentsInner]] = None
    scanned: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["payments", "scanned"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "payments": [ScanPayments200ResponseDataPaymentsInner.from_dict(_item) for _item in obj["payments"]] if obj.get("payments") is not None else None,
