...
class StealthGenerateBatch200ResponseDataResultsInner(BaseModel):
    """
    StealthGenerateBatch200ResponseDataResultsInner
    """ # noqa: E501
    index: Optional[StrictInt] = None
    success: Optional[StrictBool] = None
    data: Optional[StealthGenerate200ResponseData] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["index", "success", "data", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": StealthGenerate200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
