...
class CommitmentCreateBatch200ResponseDataResultsInner(BaseModel):
    """
    CommitmentCreateBatch200ResponseDataResultsInner
    """ # noqa: E501
    index: Optional[StrictInt] = None
    success: Optional[StrictBool] = None
    data: Optional[CommitmentAdd200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CommitmentAdd200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error")
        })
        return _obj
