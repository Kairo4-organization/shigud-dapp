...
class StealthGenerateBatch200ResponseData(BaseModel):
    """
    StealthGenerateBatch200ResponseData
    """ # noqa: E501
    results: Optional[List[StealthGenerateBatch200ResponseDataResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [StealthGenerateBatch200ResponseDataResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
