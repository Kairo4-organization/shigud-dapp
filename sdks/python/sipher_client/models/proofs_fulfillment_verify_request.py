...
class ProofsFulfillmentVerifyRequest(BaseModel):
    """
    ProofsFulfillmentVerifyRequest
    """ # noqa: E501
    type: StrictStr
    proof: Annotated[str, Field(strict=True)]
    public_inputs: List[Annotated[str, Field(strict=True)]] = Field(alias="publicInputs")
