...
class TransferPrivate422ResponseError(BaseModel):
    """
    TransferPrivate422ResponseError
    """ # noqa: E501
    code: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    supported_chains: Optional[List[StrictStr]] = Field(default=None, alias="supportedChains")
    __properties: ClassVar[List[str]] = ["code", "message", "supportedChains"]
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['CHAIN_TRANSFER_UNSUPPORTED']):
            raise ValueError("must be one of enum values ('CHAIN_TRANSFER_UNSUPPORTED')")
        return value
