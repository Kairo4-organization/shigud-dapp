...
class ViewingKeyDiscloseRequest(BaseModel):
    """
    ViewingKeyDiscloseRequest
    """ # noqa: E501
    viewing_key: ViewingKey = Field(alias="viewingKey")
    transaction_data: ViewingKeyDiscloseRequestTransactionData = Field(alias="transactionData")
    __properties: ClassVar[List[str]] = ["viewingKey", "transactionData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactionData": ViewingKeyDiscloseRequestTransactionData.from_dict(obj["transactionData"]) if obj.get("transactionData") is not None else None
        })
        return _obj
