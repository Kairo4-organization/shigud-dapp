...
class GetReady200ResponseData(BaseModel):
    """
    GetReady200ResponseData
    """ # noqa: E501
    ready: Optional[StrictBool] = None
    checks: Optional[GetReady200ResponseDataChecks] = None
    __properties: ClassVar[List[str]] = ["ready", "checks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ready": obj.get("ready"),
            "checks": GetReady200ResponseDataChecks.from_dict(obj["checks"]) if obj.get("checks") is not None else None
        })
        return _obj
