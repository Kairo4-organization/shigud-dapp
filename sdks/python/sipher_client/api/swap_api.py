...
class SwapApi:
    ...
    def private_swap(
        self,
        private_swap_request: PrivateSwapRequest,
        ...
        :param private_swap_request: (required)
        :type private_swap_request: PrivateSwapRequest
        ...
        _param = self._private_swap_serialize(
            private_swap_request=private_swap_request,
    ...
    @validate_call
    def private_swap_with_http_info(
        self,
        private_swap_request: PrivateSwapRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PrivateSwap200Response]:
        """Privacy-preserving token swap via Jupiter DEX
    ...
    @validate_call
    def private_swap_without_preload_content(
        self,
        private_swap_request: PrivateSwapRequest,
        _request_timeout: Union[
            None,
    ...
    def _private_swap_serialize(
        self,
        private_swap_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if private_swap_request is not None:
            _body_params = private_swap_request
