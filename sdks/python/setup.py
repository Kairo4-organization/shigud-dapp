...
setup(
    name=NAME,
    version=VERSION,
    description="Sipher — Privacy-as-a-Skill API",
    author="SIP Protocol",
    author_email="hello@sip-protocol.org",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Sipher — Privacy-as-a-Skill API"],
    ...
    REST API wrapping SIP Protocol&#39;s privacy SDK for Solana agents. Stealth addresses, Pedersen commitments, shielded transfers, and viewing key compliance.
    """,  # noqa: E501
    package_data={"sipher_client": ["py.typed"]},
)