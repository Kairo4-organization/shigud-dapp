...
class TestStealthDerive200ResponseData(unittest.TestCase):
    """StealthDerive200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StealthDerive200ResponseData:
        """Test StealthDerive200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StealthDerive200ResponseData`
        """
        model = StealthDerive200ResponseData()
        if include_optional:
            return StealthDerive200ResponseData(
    ...
    def testStealthDerive200ResponseData(self):
        """Test StealthDerive200ResponseData"""
