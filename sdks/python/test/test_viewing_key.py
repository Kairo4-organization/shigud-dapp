...
class TestViewingKey(unittest.TestCase):
    """ViewingKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewingKey:
        """Test ViewingKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewingKey`
        """
        model = ViewingKey()
        if include_optional:
            return ViewingKey(
