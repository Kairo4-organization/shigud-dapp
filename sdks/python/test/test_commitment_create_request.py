...
class TestCommitmentCreateRequest(unittest.TestCase):
    """CommitmentCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommitmentCreateRequest:
        """Test CommitmentCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommitmentCreateRequest`
        """
        model = CommitmentCreateRequest()
        if include_optional:
            return CommitmentCreateRequest(
                value = '4',
    ...
    def testCommitmentCreateRequest(self):
        """Test CommitmentCreateRequest"""
