...
class TestPrivacyScoreRequest(unittest.TestCase):
    """PrivacyScoreRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivacyScoreRequest:
        """Test PrivacyScoreRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivacyScoreRequest`
        """
        model = PrivacyScoreRequest()
        if include_optional:
            return PrivacyScoreRequest(
    ...
    def testPrivacyScoreRequest(self):
        """Test PrivacyScoreRequest"""
