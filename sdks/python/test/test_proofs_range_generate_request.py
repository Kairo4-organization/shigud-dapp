...
class TestProofsRangeGenerateRequest(unittest.TestCase):
    """ProofsRangeGenerateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProofsRangeGenerateRequest:
        """Test ProofsRangeGenerateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProofsRangeGenerateRequest`
        """
        model = ProofsRangeGenerateRequest()
        if include_optional:
            return ProofsRangeGenerateRequest(
                value = '4',
                threshold = '4',
    ...
    def testProofsRangeGenerateRequest(self):
        """Test ProofsRangeGenerateRequest"""
