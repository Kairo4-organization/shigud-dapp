...
class TestTransferPrivate200Response(unittest.TestCase):
    """TransferPrivate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferPrivate200Response:
        """Test TransferPrivate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferPrivate200Response`
        """
        model = TransferPrivate200Response()
        if include_optional:
            return TransferPrivate200Response(
                success = True,
                data = sipher_client.models.transfer_private_200_response_data.transferPrivate_200_response_data(
                    chain = '', 
                    curve = 'ed25519', 
                    stealth_address = '', 
    ...
    def testTransferPrivate200Response(self):
        """Test TransferPrivate200Response"""
